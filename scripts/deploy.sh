# Usage:
#   ./scripts/deploy.sh "net10.0" "user@server.domain.tld" "/var/www/www.domain.tld" "kestrel-service" "/opt/wateralarm-cli" "/opt/wateralarm-admin"
...
ssh $TARGET_SERVER "date -Iseconds > $TARGET_PATH/.wateralarm-deploy-time"
